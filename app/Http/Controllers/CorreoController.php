    ...
    class CorreoController extends Controller{
        ...
        public function contactar(Request $request){
            ...
            if($validator->fails()){
                ...
                $inputData['in_month'] = $this->setMonth($checkin[1]);
                $inputData['in_year'] = $checkin[0];

                $checkout = explode('-', $inputData['checkout']);
                $inputData['out_day'] = $checkout[2];
                $inputData['out_month'] = $this->setMonth($checkout[1]);
                $inputData['out_year'] = $checkout[0];
